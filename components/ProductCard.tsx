...
export function ProductCard({ product, solidBackground, showBadge }: { product: Product, solidBackground?: boolean, showBadge?: boolean }) {
  ...
  return (
    <article className="group flex flex-col h-full overflow-hidden rounded-[24px] bg-[#fdf6f0]/70 dark:bg-[#2d2925]/70 backdrop-blur-sm border border-[#b8935a]/20 dark:border-[#b8935a]/15 shadow-[0_8px_30px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_16px_40px_rgba(184,149,105,0.2)] dark:hover:shadow-[0_16px_40px_rgba(203,166,119,0.25)] hover:-translate-y-1.5 transition-all duration-500">
      ...
      {/* Content Area */}
      <div className="px-2.5 sm:px-4 md:px-5 pb-2.5 sm:pb-4 md:pb-5 pt-1 flex flex-col flex-grow transition-colors duration-500">
        {/* Product Name */}
