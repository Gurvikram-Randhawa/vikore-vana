...
export function ProductCard({ product }: { product: Product }) {
  return (
    <article className="group flex flex-col h-full overflow-hidden rounded-2xl bg-[#fdf6f0]/70 dark:bg-[#25211e]/70 backdrop-blur-sm border border-[#b8935a]/20 dark:border-[#b8935a]/15 shadow-[0_4px_16px_rgba(184,147,90,0.06)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.25)] hover:shadow-[0_12px_32px_rgba(184,147,90,0.14)] dark:hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)] hover:-translate-y-1.5 transition-all duration-500">
