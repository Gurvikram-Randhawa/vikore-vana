...
const categoryData: CategoryItem[] = [
  {
    ...
    slug: "living-room",
    icon: (
      <svg viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-16 h-16">
        <path d="M10 44h44" />
    ...
    <div className="h-full">
      ...
      >
        <div className="flex flex-col items-center">
          {/* SVG ILLUSTRATION */}
          <div className="flex justify-center items-center text-[#b8935a] dark:text-[#cba677] transition-transform duration-500 group-hover:scale-105 md:scale-130 md:mb-3">
            {item.icon}
          </div>
