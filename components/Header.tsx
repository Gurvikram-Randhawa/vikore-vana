        ...
        <div className="container-premium py-2 md:h-16 md:py-0 flex flex-col md:flex-row justify-center md:justify-between gap-2 md:gap-4">
          ...
          <div className="hidden md:flex flex-1 items-center justify-end gap-2">
            ...
            <button 
              ...
              onClick={toggle} 
              className="grid size-11 place-items-center rounded-full border border-[#b8935a]/30 dark:border-[#b8935a]/20 bg-white/50 dark:bg-white/5 backdrop-blur-sm shadow-sm transition hover:bg-black/5 dark:hover:bg-white/10"
            >
