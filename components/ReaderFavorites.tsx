      ...
      <Link href={`/articles/${pin.slug}`}>
        ...
        >
          ...
          <div className={`relative ${aspect} bg-bone/30 dark:bg-black/20`}>
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent transition-opacity duration-500 ${isHovered ? "opacity-100" : "opacity-0"
                }`}
            />
            ...
            <div
              className={`absolute bottom-0 left-0 right-0 p-3.5 transition-all duration-500 ${isHovered
